...
const Prescription = ({ appointment }) => {
    ...
    const { createNewPrescription } = useDB();
    ...
    const handleSubmit = async(values, props) => {
        ...
        try {
            ...
            createNewPrescription(appointment.patientName,appointment.appointmentDate,appointment.time_slot,currentUser.email, values.disease, values.medication);
