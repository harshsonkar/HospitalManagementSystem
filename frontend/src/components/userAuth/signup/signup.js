...
import { Avatar, Button, CssBaseline, TextField, Paper, Link, Grid, Box, Typography, Container, InputAdornment, IconButton } from '@mui/material';
...
import DatePickerField from '../../Controls/Pickers/DatePicker';
const Signup = () => {
    ...
    const varCurrentTime=new Date();
    // console.log(varCurrentTime)
    const initialValues = {
        firstName: '',
        lastName: '',
        email: '',
    ...
    const handleSubmit = async(values, props) => {
        ...
        if(values.dob===undefined){
            return setError('please select date of Date of birth')
        }
        try {
            setError('')
            setLoading(true)
                        ...
                        {(props) => (
                            <Form>
                                ...
                                <Field
                                    ...
                                    helperText={<ErrorMessage name="House Number"/>}
                                />
                                </Grid>
                                <Grid item xs={12} sm={6}>
                                <Field
